    ...
    return (
        <div className="flex flex-col md:flex-row items-center min-h-screen px-8 container mx-auto w-full">
            ...
            <div className="md:w-1/2 text-center md:text-left order-2 md:order-1 mt-12">
                ...
                <p className="text-sm text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla minus autem possimus, nihil perferendis itaque dolor omnis nostrum? Eum, totam!</p>
                <div className='mt-5'>
